...
PROJECT_ID = 'bookshelf-project-309411'

# CloudSQL & SQLAlchemy configuration
# Replace the following values the respective values of your Cloud SQL
# instance.
CLOUDSQL_USER = 'db_user'
CLOUDSQL_PASSWORD = 'user123'
CLOUDSQL_DATABASE = 'bookshelf-sql-instance-11'
# Set this value to the Cloud SQL connection name, e.g.
#   "project:region:cloudsql-instance".
# You must also update the value in app.yaml.
CLOUDSQL_CONNECTION_NAME = 'bookshelf-project-309411:us-central1:bookshelf-sql-instance-11'
...
# CLOUD_STORAGE_BUCKET = 'bookshelf-project-309411-bucket'
